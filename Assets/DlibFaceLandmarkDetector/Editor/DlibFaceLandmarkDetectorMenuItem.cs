...
namespace DlibFaceLandmarkDetector.Editor
{
    ...
    new Dictionary<BuildTarget, Dictionary<string, string>>() { {BuildTarget.StandaloneLinux64,new Dictionary<string, string> () { {
        ...
        public static void SetWebGLPluginImportSettings(string pluginsFolderPath, string extraFolderPath, bool displayProgressBar = false)
        {
            ...
            SetPlugins(new string[] { pluginsFolderPath + "/WebGL/2023.2/dlibfacelandmarkdetector.bc" }, null, new Dictionary<BuildTarget, Dictionary<string, string>>() { {
                                BuildTarget.WebGL,
                                null
                            }
                        }, displayProgressBar);
            ...
            SetPlugins(new string[] { pluginsFolderPath + "/WebGL/2023.2/dlibfacelandmarkdetector.bc" }, null, null, displayProgressBar);
        ...
        public static void UseUnsafeCode(bool enable)
        {
            ...
            if (!enable) {
                ...
                {
#if UNITY_2021_2_OR_NEWER
                    Symbol.Remove(NamedBuildTarget.Standalone, Symbol.GetCurrentSymbols(NamedBuildTarget.Standalone), SYMBOL_DLIB_USE_UNSAFE_CODE);
                    Symbol.Remove(NamedBuildTarget.Android, Symbol.GetCurrentSymbols(NamedBuildTarget.Android), SYMBOL_DLIB_USE_UNSAFE_CODE);
                    Symbol.Remove(NamedBuildTarget.iOS, Symbol.GetCurrentSymbols(NamedBuildTarget.iOS), SYMBOL_DLIB_USE_UNSAFE_CODE);
                    Symbol.Remove(NamedBuildTarget.WebGL, Symbol.GetCurrentSymbols(NamedBuildTarget.WebGL), SYMBOL_DLIB_USE_UNSAFE_CODE);
                    Symbol.Remove(NamedBuildTarget.WindowsStoreApps, Symbol.GetCurrentSymbols(NamedBuildTarget.WindowsStoreApps ), SYMBOL_DLIB_USE_UNSAFE_CODE);
#else
            ...
            else
            {
                ...
                {
#if UNITY_2021_2_OR_NEWER
                    Symbol.Add(NamedBuildTarget.Standalone, Symbol.GetCurrentSymbols(NamedBuildTarget.Standalone), SYMBOL_DLIB_USE_UNSAFE_CODE);
                    Symbol.Add(NamedBuildTarget.Android, Symbol.GetCurrentSymbols(NamedBuildTarget.Android), SYMBOL_DLIB_USE_UNSAFE_CODE);
                    Symbol.Add(NamedBuildTarget.iOS, Symbol.GetCurrentSymbols(NamedBuildTarget.iOS), SYMBOL_DLIB_USE_UNSAFE_CODE);
                    Symbol.Add(NamedBuildTarget.WebGL, Symbol.GetCurrentSymbols(NamedBuildTarget.WebGL), SYMBOL_DLIB_USE_UNSAFE_CODE);
                    Symbol.Add(NamedBuildTarget.WindowsStoreApps, Symbol.GetCurrentSymbols(NamedBuildTarget.WindowsStoreApps), SYMBOL_DLIB_USE_UNSAFE_CODE);
#else
